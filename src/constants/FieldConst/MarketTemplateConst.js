...
export const MarketTemplateFileds = [
    ...
    },
    {
        name: "lineType",
        label: "Line Type",
        options: [{ label: "Select Line Type", value: "0" }, { label: "backlayline", value: "1" }, { label: "layline", value: "2" }, { label: "backOnly", value: "3" }, { label: "layOnly", value: "4" }],
        type: SELECT,
        defaultValue: false,
        isRequired: true,
        labelColspan: { xs: 12, md: 2, lg: 2 },
    ...
    {
        type: TEXT,
        name: "defaultBackSize",
        label: "Default BackSize",
        isRequired: true,
        defaultValue: 100,
        labelColspan: { xs: 12, md: 2, lg: 2 },
        fieldColspan: { xs: 12, md: 4, lg: 4 },
