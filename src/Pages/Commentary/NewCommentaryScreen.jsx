...
const NewCommentaryScreen = ({
  ...
  console.log("extrasTypeToggle", extrasTypeToggle);
  console.log("updateExtrasExtrasType", updateExtrasExtrasType);
        ...
        <Col xs={12} md={7} lg={7}>
          ...
          <div className="control-card bg-secondary text-white mb-4">
            <div className="control-card-body">
              ...
              {/* Number Pad */}
              <div className="d-flex m-0 p-0 w-100 g-1">
                <div
                ...
                >
                  {actionPopup ? (
                    <>
                      <div className="col">
                        <button className="score-control-action-btns">5</button>
                      </div>
                      <div
                        className="col"
                        onClick={() => {
                    ...
                    <div className="col-12">
                      ...
                      <div className="col d-flex justify-content-center gap-4 px-3">
                        <div className="col-6" onClick={() => extraTypehandleSubmit(EXTRAS)}>
                    ...
                    <>
                      {currentStep === 1 ? (
                        ...
                        <div className="col-12 mb-2">
                          ...
                          {extraType && (
                            <div className="mb-3">Ball Type: {extraType}</div>
                          )}
                          <div className="my-4 col-12">
                          ...
                          {showFields.batterId && (
                            <div className="mb-4">
                              <div className="wicket-section-header mb-2">
                                Select Batsman:
                              </div>
                    ...
                    // <>
                    //   <div className="col">
                    //     <button className="score-control-wicket-ball-btns">
                    //       Bowled
                    //     </button>
                    //   </div>
                    //   <div className="col">
                    ...
                    //   </div>
                    //   <div className="col">
                    //     <button className="score-control-close-btn">
                    //       Close
                    //     </button>
                    //   </div>
                    // </>
