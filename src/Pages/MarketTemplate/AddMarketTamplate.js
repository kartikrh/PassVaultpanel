...
import { ERROR, PERMISSION_ADD, PERMISSION_EDIT, PERMISSION_VIEW, SAVE, SAVE_AND_CLOSE, SAVE_AND_NEW, TAB_MARKET_TEMPLATE } from '../../components/Common/Const';
import { addMarketTemplateToDb, updateSavedState } from "../../Features/Tabs/marketTemplateSlice";
...
function AddMarketTemaplate() {
  ...
  const [marketTemplateId, setMarketTemplateId] = useState(location.state?.marketTemplateId || "0")
  ...
  const handleSaveClick = async (saveAction) => {
    ...
    if (dataToSave) {
      ...
      dispatch(addMarketTemplateToDb({marketTemplateId:0,...dataToSave}))
    }
  };
